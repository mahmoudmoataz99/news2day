            ...
            {user ? (
              <>
                <button 
                  ...
                  className="bg-white text-gray-800 p-3 font-bold text-lg rounded-full hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                >
