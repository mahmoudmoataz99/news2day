...
const Settings = () => {
  ...
  const validateForm = (isPasswordChange = false) => {
    const { firstName, lastName, email, currentPassword, newPassword, confirmPassword } = state.formData;
    const newErrors = {};
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
       ...
       const response = await axios.put(
         `https://newstoday-nest.vercel.app/user/myprofile`,
         {
  ...
  //   try {
  //     await axios.delete('https://newstoday-nest.vercel.app/user/delete-account', {
