...
const AddArticle = () => {
    ...
    useEffect(() => {
        if (user) {
            // Handle both First_Name/Last_Name (from stored user) and firstName/lastName (from auth response)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let errorMsg = 'Error adding article';
            ...
            if (error.response?.data?.message) {
              ...
              errorMsg = error.message || 'Error adding article';
            }
